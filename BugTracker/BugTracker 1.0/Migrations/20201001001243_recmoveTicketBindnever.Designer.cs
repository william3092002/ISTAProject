...
namespace BugTracker.Migrations
{
    ...
    [Migration("20201001001243_recmoveTicketBindnever")]
    partial class recmoveTicketBindnever
    {
            ...
            modelBuilder.Entity("BugTracker.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectCreated = new DateTime(2020, 9, 30, 20, 12, 43, 380, DateTimeKind.Local).AddTicks(7782),
                        ...
                        new
                        {
                            ...
                            ProjectCreated = new DateTime(2020, 9, 30, 20, 12, 43, 384, DateTimeKind.Local).AddTicks(5671),
                        ...
                        new
                        {
                            ...
                            ProjectCreated = new DateTime(2020, 9, 30, 20, 12, 43, 384, DateTimeKind.Local).AddTicks(5827),
            ...
            modelBuilder.Entity("BugTracker.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 384, DateTimeKind.Local).AddTicks(9332),
                        ...
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(32),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(79),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(102),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 2,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(121),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 2,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(143),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 3,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(161),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Bug"
                        },
                        new
                        {
                            ...
                            ProjectId = 3,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 9, 30, 20, 12, 43, 385, DateTimeKind.Local).AddTicks(180),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Bug"
                        });
                });
