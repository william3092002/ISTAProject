...
namespace BugTracker.Migrations
{
    ...
    [Migration("20201003193040_addSeedRecord")]
    partial class addSeedRecord
    {
            ...
            modelBuilder.Entity("BugTracker.Models.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectCreated = new DateTime(2020, 10, 3, 15, 30, 40, 383, DateTimeKind.Local).AddTicks(3172),
                        ...
                        new
                        {
                            ...
                            ProjectCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(346),
                        ...
                        new
                        {
                            ...
                            ProjectCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(503),
            ...
            modelBuilder.Entity("BugTracker.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(5772),
                        ...
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6443),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6492),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 1,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6515),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 2,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6535),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 2,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6559),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Feature"
                        },
                        new
                        {
                            ...
                            ProjectId = 3,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6630),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Bug"
                        },
                        new
                        {
                            ...
                            ProjectId = 3,
                            Status = "Open",
                            TicketCreated = new DateTime(2020, 10, 3, 15, 30, 40, 387, DateTimeKind.Local).AddTicks(6655),
                            TicketUpdated = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = "Bug"
                        });
                });
